# -*- coding: utf-8 -*-
#
# ESMP documentation build configuration file, created by
...
def skip(app, what, name, obj, skip, options):
    matches = ['__init__', '__del__', '__call__', '__new__']
...
man_pages = [
    ('index', 'esmpy', 'ESMPy Documentation',
     ['ESMPy'], 1)
]
...
texinfo_documents = [
  ('index', 'ESMPy', 'ESMPy Documentation',
   'ESMPy', 'ESMPy', 'Python interface to ESMF',
   'Miscellaneous'),
]
